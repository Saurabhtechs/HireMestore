# Generated by Django 3.2.6 on 2022-11-20 08:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub', models.ManyToManyField(related_name='Sub_data', to='core.Sub_data')),
                ('sub_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.subcategory')),
