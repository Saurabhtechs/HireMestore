...
class CategoryFilter(django_filters.FilterSet):
    ...
    category = django_filters.ModelChoiceFilter(queryset=Category.objects.all(), label='city', distinct=True, empty_label=('Choose Category'))

    class Meta:
        model = User_Detail
        fields = ['city','category','state']
